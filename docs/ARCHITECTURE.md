...
freelancehub is structured as a production-oriented project with separated responsibilities across application code, infrastructure, and documentation.
...
- `app/`: application entry points and feature modules
- `config/`: project-specific module group
- `database/`: schema, migrations, and seed data
- `db/`: project-specific module group
- `frontend/`: user interface, state management, and visual components
- `spec/`: project-specific module group
